...
\section*{Challenges Chapter 8 (8.9)}
    ...
    \subsection*{Challenge 1 (8.9.1)}
        ...
        \end{minted}
        \fbox{\begin{minipage}{\textwidth}
            is a bifunctor. For additional creditimplement all three methods of Bifunctor and use equational reasoning to show that these definitions are compatible with the default implementations whenever they can be applied.
        \end{minipage}}
        \begin{minted}{haskell}
            data Pair a b = Pair a b
    ...
    \subsection*{Challenge 2 (8.9.2)}
        \fbox{\begin{minipage}{\textwidth}
            Show the isomorphism between the standard definition of Maybe an this desugaring:
        \end{minipage}}
        \begin{minted}{haskell}
    ...
    \subsection*{Challenge 3 (8.9.3)}
        ...
        \end{minted}
        \fbox{\begin{minipage}{\textwidth}
            You could recover our erlier definition of a List by recursively applying PreList to itself (we'll see how it's done when we talk about fixed points).\\
    ...
    \subsection*{Challenge 4 (8.9.4)}
        ...
        \fbox{\begin{minipage}{\textwidth}
            ...
            McBride's paper Clowns to the Left of me, Jokers to the Right1 .
        \end{minipage}}
        \begin{minted}{haskell}
